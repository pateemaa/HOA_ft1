...
INSERT INTO `HOADB`.`assets` (`asset_id`, `asset_name`, `asset_description`, `acquisition_date`, `forrent`, `asset_value`, `type_asset`, `status`, `loc_lattitude`, `loc_longiture`, `hoa_name`, `enclosing_asset`) VALUES (5011, 'Vase', 'Vase', '2022-03-05', 1, 350, '0', 'W', 101.333, 101.333, 'SJH', NULL);
...
INSERT INTO `HOADB`.`asset_transactions` (`asset_id`, `transaction_date`, `trans_hoid`, `trans_position`, `trans_electiondate`, `isdeleted`, `approval_hoid`, `approval_position`, `approval_electiondate`, `ornum`, `transaction_type`) VALUES (5003, '2022-12-28', 9003, 'Vice-President', '2022-12-01', 0, NULL, NULL, NULL, NULL, 'A');
